...
#ifndef __S3C2450_FIL_H__
#define __S3C2450_FIL_H__
...
//CommentPilsun
#define NF_SECC()			(pNANDFConReg->NFSECC)
...
#define NF_WRMECCD0(data)			{pNANDFConReg->NFMECCD0 = (data);}
#define NF_WRMECCD1(data)			{pNANDFConReg->NFMECCD1 = (data);}
#define NF_WRSECCD(data)			{pNANDFConReg->NFSECCD = (data);}
...
///////////////////////////////////////////////
#define NAND_SPAREPAGE_SIZE			(128)
...
typedef struct {
	...
	UINT32	aMECC[8*2];			// 16 bytes ECC for Sec0~Sec3 in Main Area, 16 bytes ECC for Sec4~Sec7 in Main Area for 4K page, 32 bytes dummy.
